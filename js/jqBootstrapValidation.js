        ...
        t = {
                ...
                init: function (o) {
                    ...
                    return (
                        a(l).bind("submit", function (e) {
                            var t = a(this),
                                i = 0,
                                n = t.find("input,textarea,select").not("[type=submit],[type=image]").filter(r.options.filter);
                            n.trigger("submit.validation").trigger("validationLostFocus.validation"),
                                ...
                                i
                                    ? (r.options.preventSubmit && e.preventDefault(), t.addClass("error"), a.isFunction(r.options.submitError) && r.options.submitError(t, e, n.jqBootstrapValidation("collectErrors", !0)))
                                    : (t.removeClass("error"), a.isFunction(r.options.submitSuccess) && r.options.submitSuccess(t, e));
                        }),
                        this.each(function () {
                            var t = a(this),
                            ...
                            if ((!l.length && r.options.autoAdd && r.options.autoAdd.helpBlocks && ((l = a('<div class="help-block" />')), o.find(".controls").append(l), e.push(l[0])), r.options.sniffHtml)) {
                                ...
                                if (
                                    (void 0 !== t.attr("pattern") &&
                                        ((c = "Not in the expected format\x3c!-- data-validation-pattern-message to override --\x3e"),
                                    ...
                                    (c = "Too high: Maximum of '" + v + "'\x3c!-- data-validation-max-message to override --\x3e"),
                                        t.data("validationMaxMessage") && (c = t.data("validationMaxMessage")),
                                ...
                                if (void 0 !== t.attr("min") || void 0 !== t.attr("aria-valuemin")) {
                                    ...
                                    (c = "Too low: Minimum of '" + u + "'\x3c!-- data-validation-min-message to override --\x3e"),
                                        t.data("validationMinMessage") && (c = t.data("validationMinMessage")),
                                        t.data("validationMinMessage", c),
                                        t.data("validationMinMin", u);
                                }
                                void 0 !== t.attr("maxlength") &&
                                    ((c = "Too long: Maximum of '" + t.attr("maxlength") + "' characters\x3c!-- data-validation-maxlength-message to override --\x3e"),
                                    ...
                                    void 0 !== t.attr("minlength") &&
                                        ((c = "Too short: Minimum of '" + t.attr("minlength") + "' characters\x3c!-- data-validation-minlength-message to override --\x3e"),
                                    ...
                                    (void 0 === t.attr("required") && void 0 === t.attr("aria-required")) ||
                                        ((c = r.builtInValidators.required.message), t.data("validationRequiredMessage") && (c = t.data("validationRequiredMessage")), t.data("validationRequiredMessage", c)),
                                    void 0 !== t.attr("type") &&
                                        "number" === t.attr("type").toLowerCase() &&
                                        ((c = r.builtInValidators.number.message), t.data("validationNumberMessage") && (c = t.data("validationNumberMessage")), t.data("validationNumberMessage", c)),
                                    void 0 !== t.attr("type") &&
                                        "email" === t.attr("type").toLowerCase() &&
                                        ((c = "Not a valid email address\x3c!-- data-validator-validemail-message to override --\x3e"),
                                    ...
                                    void 0 !== t.attr("minchecked") &&
                                        ((c = "Not enough options checked; Minimum of '" + t.attr("minchecked") + "' required\x3c!-- data-validation-minchecked-message to override --\x3e"),
                                    ...
                                    void 0 !== t.attr("maxchecked") &&
                                        ((c = "Too many options checked; Maximum of '" + t.attr("maxchecked") + "' required\x3c!-- data-validation-maxchecked-message to override --\x3e"),
                            ...
                            void 0 !== t.data("validation") && (d = t.data("validation").split(",")),
                            ...
                            a.each(d, function (e, n) {
                                var o = t.data("validation" + n + "Message"),
                                    ...
                                    s = !1;
                                if (
                                    ((o = o || "'" + n + "' validation failed \x3c!-- Add attribute 'data-validation-" + n.toLowerCase() + "-message' to input to change this message --\x3e"),
                                ...
                                t.bind("validation.validation", function (e, i) {
                                    ...
                                    return (
                                        a.each(h, function (e, n) {
                                            (o || o.length || (i && i.includeEmpty) || (r.validatorTypes[e].blockSubmit && i && i.submitting)) &&
                                ...
                                t.bind(["keyup", "focus", "blur", "click", "keydown", "keypress", "change"].join(".validation ") + ".validation", function (e, i) {
                                    ...
                                    o.find("input,textarea,select").each(function (e, n) {
                                        ...
                                        (c = a.unique(c.sort())).length
                                            ...
                                            : (o.removeClass("warning error success"), d.length > 0 && o.addClass("success"), l.html(l.data("original-contents"))),
            ...
            validatorTypes: {
                ...
                regex: {
                    name: "regex",
                    init: function (a, e) {
                        return { regex: ((t = a.data("validation" + e + "Regex")), new RegExp("^" + t + "$")) };
                        var t;
                    },
                    validate: function (a, e, t) {
